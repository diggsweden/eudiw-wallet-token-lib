...
class MdlPresentationValidatorTest {
  ...
  void testCases() throws Exception {
    ...
    MdlPresentationValidationInput validationInput = new MdlPresentationValidationInput(presentationInput);
    ...
    wrongNonceInput.setMdocGeneratedNonce(presentationInput.getMdocGeneratedNonce());
    ...
    wrongAudienceInput.setMdocGeneratedNonce(presentationInput.getMdocGeneratedNonce());
  ...
  void performTestCase(String description, MdlPresentationValidator validator, MdlPresentationValidationInput input,
    ...
    if (expectedException != null) {
      ...
      MdlPresentationValidationResult validationResult = validator.validatePresentation(presentation, input, trustedKeys);
