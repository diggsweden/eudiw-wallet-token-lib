...
/**
 * Represents the result of validation for an mDL (Mobile Driving License) presentation. This class
 * extends the {@code MdlIssuerSignedValidationResult} and includes additional fields to capture
 * specific information and status relevant to the mDL presentation.
 */
...
public class MdlPresentationValidationResult
   ...
   *
   * @param issuerSignedValidationResult the issuer-signed validation result containing validation
   *        key, certificate, chain, wallet public key, issue time, expiration time, presentation
   *        request nonce, issuer signed data, and Mobile Security Object (MSO).
   ...
   * @param disclosedAttributes a map of attributes disclosed during the validation, where the key
   *        is the attribute type and the value is the attribute's value
   */
