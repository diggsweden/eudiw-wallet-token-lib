...
public class SessionTranscript {
  ...
  /**
   * Converts the session transcript data into a CBOR object representation. This includes
   * generating a handover array containing hashed items of required fields, as well as structuring
   * the session transcript array.
   *
   * @return a CBORObject representation of the session transcript, containing the handover data and
   *         session structure.
   * @throws NullPointerException if any required field (clientId, responseUri, nonce, or
   *         mdocGeneratedNonce) is null.
   */
   ...
   * @param mdocGeneratedNonce the nonce generated by the mobile document (mdoc), used as the other
   *        input parameter for the hash
