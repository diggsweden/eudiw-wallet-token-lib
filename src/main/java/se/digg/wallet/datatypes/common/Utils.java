...
public class Utils {
  ...
  /**
   * Ensures that the provided object is a Map with String keys and returns it as a
   * {@code Map&ltString, Object>}. If the input is not a Map with String keys, an
   * IllegalArgumentException is thrown.
   *
   * @param value the object to validate and cast
   * @return the validated and cast {@code Map&ltString, Object>}
   * @throws IllegalArgumentException if the provided object is not a Map or if the Map's keys are
   *         not Strings
   */
  ...
  /**
   * Ensures that the provided object is a List containing only String elements and returns it as a
   * {@code List<String>}. If the input object is not a List with all String elements, an
   * IllegalArgumentException is thrown.
   *
   * @param value the object to validate and cast
   * @return the validated and cast {@code List<String>}
   * @throws IllegalArgumentException if the provided object is not a List or if the List's elements
   *         are not all Strings
   */
  @SuppressWarnings("unchecked")
